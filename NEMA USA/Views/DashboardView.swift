    ...
    var body: some View {
        ...
        .task {
            if eventRepository.events.isEmpty {
                ...
                await eventRepository.loadEventsFromCoreData() //fetchLimit: 10) // Load from local store first with fetch limit
                ...
                await eventRepository.loadEventsFromCoreData() //fetchLimit: 10) // Still load a limited set for UI
